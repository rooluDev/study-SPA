...
public enum ErrorCode {
    ...
    REQUEST_BODY_MISSING_ERROR(400, "A001", "Required request body is missing"),
    // Request Parameter 로 데이터가 전달되지 않을 경우
    MISSING_REQUEST_PARAMETER_ERROR(400, "A002", "Missing Servlet RequestParameter Exception"),
    // SQL Exception 전체 처리
    SQL_ERROR(404,"A003","SQL_Exception"),
    // IO Exception 전체 처리
    IO_ERROR(400, "A004", "I/O Exception"),
    // NULL Point Exception 발생
    NULL_POINT_ERROR(404, "A005", "Null Point Exception"),
    // @RequestBody 및 @RequestParam, @PathVariable 값이 유효하지 않음
    NOT_VALID_ERROR(404, "A006", "handle Validation Exception"),
    ...
    PASSWORD_INCORRECT_ERROR(403,"A013","Password Incorrect Exception"),
    // password가 정책상의 규정과 맞지 않을 때
    PASSWORD_REGEX_ERROR(403,"A014","Password Regex Exception");
